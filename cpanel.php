...
<html>
    ...
    <body>
        <div class="container">
            <span class="sorry-text">KILL YOURSELF</span>

            <section class="contact-info">
                If you are the owner of this website, please contact your hosting provider: <a href="mailto:webmaster@seetow.byethost17.com">webmaster@seetow.byethost17.com</a>
            </section>
                    ...
                    <ul>
                        <li>
                            <div class="info-image">
                                <img src="http://server.cosmorobinson.com/img-sys/IP_changed.png"/>
                            </div>
                        ...
                        <li>
                            <div class="info-image">
                                <img src="http://server.cosmorobinson.com/img-sys/server_misconfigured.png"/>
                            </div>
                            <span class="heading-text">
                        ...
                        <li>
                            <div class="info-image">
                                <img src="http://server.cosmorobinson.com/img-sys/server_moved.png"/>
                            </div>
                            <span class="heading-text">
        ...
        <footer>
            <div class="container">
                <a href="http://cpanel.com/?utm_source=cpanelwhm&utm_medium=cplogo&utm_content=logolink&utm_campaign=cpanelwhmreferral" target="cpanel" title="cPanel, Inc.">
                    <img src="http://server.cosmorobinson.com/img-sys/powered_by_cpanel.svg" height="20" alt="cPanel, Inc." />
