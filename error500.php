<html i18n-values="dir:textdirection;lang:language" dir="ltr" lang="en" i18n-processed=""><head>
  ...
  <title i18n-content="title">https://seetow.com/ failed to load</title>
...
<body id="t" i18n-values=".style.fontFamily:fontfamily;.style.fontSize:fontsize" jstcache="0" class="neterror" style="font-family: &quot;Segoe UI&quot;, Tahoma, sans-serif; font-size: 75%;">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        <h1 jsselect="heading" jsvalues=".innerHTML:msg" jstcache="5">The <span jscontent="hostName" jstcache="16">seetow.com</span> page isn’t working</h1>
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="16">seetow.com</strong> is currently unable to handle this request.</p>
        ...
        <div class="error-code" jscontent="errorCode" jstcache="7">HTTPS_ERR_500_RESULTS_RELEASE</div>
    ...
    <div id="buttons" class="nav-wrapper suggested-left" jstcache="0">
      <div id="control-buttons" jstcache="0">
        ...
        </button><button id="reload-button" class="blue-button text-button" onclick="location.href = 'http://seetow.com';" jsselect="reloadButton" jsvalues=".url:reloadUrl; .trackingId:reloadTrackingId" jscontent="msg" jstcache="8">Reload</button>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div class="icon icon-generic" jseval="updateIconClass(this.classList, iconClass)" jstcache="1"></div>
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="16">seetow.com</strong> is currently unable to handle this request.</div>
  </div>
...
</script><script jstcache="0">loadTimeData.data = {"details":"Details","errorCode":"HTTP ERROR 500","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"seetow.com","msg":"The \u003Cspan jscontent=\"hostName\">\u003C/span> page isn’t working"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","reloadButton":{"msg":"Reload","reloadTrackingId":-1,"reloadUrl":"http://seetow.com/"},"suggestionsDetails":[],"suggestionsSummaryList":[],"summary":{"dnsDefinition":"DNS is the network service that translates a website’s name to its Internet address.","failedUrl":"http://seetow.com/","hostName":"seetow.com","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong> is currently unable to handle this request."},"textdirection":"ltr","title":"http://seetow.com/ failed to load"};</script><script jstcache="0">// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
