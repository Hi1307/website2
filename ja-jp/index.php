...
<h1>私のウェブサイトに <em><? echo $_SERVER["REMOTE_ADDR"]; ?></em> を歓迎する!</h1>
<div id="footer"><h2>これは: <a href="/en">English</a> <a href="/ch-prc">华文</a> <a href="/jp-jp">日本語</a> に翻訳されています</h2></div>
<div id="box">
<ul>
  <li><a class="active" href="#home">メイン</a></li>
  <li><a href="/welcome/">私について</a></li>
<li class="dropdown">
    <a href="#" class="dropbtn">ソーシャルメディア</a>
...
<li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <li><a target="_blank" href="/welcome/my%20files/">ファイル</a></li>
      <li><a target="_blank" href="https://www.google.com/?q=site:seetow.ga%20(搜索)">サーチ</a></li></ul></div>
...
<a href="/blog/latest" target="_blank"><h2>最新ブログ投稿</h2></a>

<h2>最新のYouTubeのビデオ</h2>
