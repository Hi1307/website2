...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li class="divider"></li>
      <li><a target="_blank" href="/twitter">ツイッター</a></li>
  <li class="divider"></li>
      <li><a target="_blank" href="https://steamcommunity.com/id/hi1307/">蒸気 (lmao)</a></li>
  <li class="divider"></li>
      <li><a target="_blank" href="https://plus.google.com/+JohnTanseetowsh">Google+</a></li>
  <li class="divider"></li>
      <li><a target="_blank" href="https://www.facebook.com/profile.php?id=100008235543326">フェイスブック</a></li>
  <li class="divider"></li>
...
<ul id="dropdown2" class="dropdown-content">
      <li><a target="_blank" href="http://ratings.fide.com/card.phtml?event=5816130">世界チェス連盟</a></li>
  <li class="divider"></li>
...
<ul id="dropdown3" class="dropdown-content">
      <li><a target="_blank" href="/dinosaur/chrome">恐竜</a></li>
  <li class="divider"></li>
      <li><a target="_blank" href="/en/games/solitaire/">ソリティア</a></li>
  <li class="divider"></li>
      <li><a target="_blank" href="/en/games/minesweeper/">Minesweeper</a></li>
</ul>
<ul id="dropdown4" class="dropdown-content">
  <li><a href="/welcome/">約</a></li>
  <li class="divider"></li>
      <li><a href="/en/blog/latest">ブログ</a></li>
  <li class="divider"></li>
  ...
  <li class="divider"></li>
      <li><a target="_blank" href="/en/rss/">ニュース</a></li>
</ul>
<ul id="dropdown5" class="dropdown-content">
  <li><a href="/ch-prc/">Chinese (PRC)</a></li>
  <li class="divider"></li>
      <li><a href="/">English (UK/SG)</a></li>
  <li class="divider"></li>
  ...
  <li class="divider"></li>
    ...
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"><i class="material-icons">home</i></a>
      ...
      <li><a class="dropdown-button" href="#!" data-activates="dropdown1"><i class="material-icons">group</i></a></li>
      <li><a class="dropdown-button" href="#!" data-activates="dropdown2"><i class="material-icons">forum</i></a></li>
      <li><a class="dropdown-button" href="#!" data-activates="dropdown3"><i class="material-icons">videogame_asset</i></a></li>
      <li><a class="dropdown-button" href="#!" data-activates="dropdown4"><i class="material-icons">explore</i></a></li>
...
<script>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">シートシンハウのウェブサイト</h1>
      <div class="row center">
        <h5 class="header col s12 light">ウェブサイトに <em><? echo $_SERVER["HTTP_CF_CONNECTING_IP"]; ?></em> を歓迎します</h5>
      </div>
      <div class="row center">
        <a href="#start" id="download-button" class="btn-large waves-effect waves-light orange">開始</a><br />
<a class="orange-text text-lighten-3" href="#">すべての言語</a>
<?php
echo("<br /> <br />インターネットブラウザ:");
...
$device_details =   "<b>".$user_os."</b>オペレーティングシステムで<b>".$user_browser."</b>を使用しています";

print_r($device_details);
?>
<br />
<p>都市、国 <b><?php echo ip_info("Visitor", "Address"); ?></b>.</p>
      </div>
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- Main1 -->
...
<script> 
  ...
  <div class="container">
    ...
    <div class="section">
<a name="start"></a>
      <h4 class="header center orange-text">新しいYouTube動画</h4>
...
<video src="https://cdn.rawgit.com/Hi1307/seetowcdn/master/Music%20Videos/Kahoot!%20Lobby%20Music%2010%20mins.mp3" width="100%" type="audio/mpeg" autoplay loop></video>
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- YouTube - Stream -->
<ins class="adsbygoogle"
     style="display:block"
...
<h4 class="header center orange-text">ライブストリーム</h4>
<p class="center orange-text">金曜日/土曜日</p>
<br />
<?php
...
echo '<p class="center orange-text">いいえ</p>';  
}  
...
?>
      <h4 class="header center orange-text">インスタグラム</h4>
<blockquote class="instagram-media" data-instgrm-captioned data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div> <p style=" margin:8px 0 0 0; padding:0 4px;"> <a href="https://www.instagram.com/p/BXvDLpxnYdz/" style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;" target="_blank">Happy Birthday Daniel. Joshua: HAPPY BDAY HUM! 🎉🎊 Hv a blessed 14th blah blah blah 🎂! Anw your welcome for THE WELL MADE CARD N BALLOON N RABBIT 🎁 that we obviously prepared 3 months ago n juz be happy for the rest of today! 😂 Today was damn JOKE, totally not aimlessly walking around coz it was so damn crowded. 🍔 Hope you were surprised today and YOU BETTER ENJOY your presents coz we put in A LOT OF EFFORT. If not... I will LOOK for you, I will HUNT you down n I will KILL you. 🔪 Cheers! :D Seanna: happy birthday daniel!! 😯😯hope you liked the &#34;surprise&#34; and lunch tday although some pple totally didn&#39;t ruin it!! may God bless you and hope you liked the balloon and the rabbit!!🎈🐰have a blessed 14th!!☺☺😫😫 Rachel: happy birthday daniel! idk how surprised were you but i hope you were surprised🙃🎈🎈🎈🎈 i miss かわいい日本人 :( @seannagoh Daniel: Tks so much for planning for tdy :)</a></p> <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">A post shared by I Wonder Who It Is 🤔 (@spamthisfeed) on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2017-08-13T13:10:25+00:00">Aug 13, 2017 at 6:10am PDT</time></p></div></blockquote> <script async defer src="//platform.instagram.com/en_US/embeds.js"></script>
      <h4 class="header center orange-text">ユーザーをReddit</h4>
...
<script async src="//embed.redditmedia.com/widgets/platform.js" charset="UTF-8"></script>
      <h4 class="header center orange-text">CartoDBマップ</h4>
<iframe width="100%" height="520" frameborder="0" src="https://hi1307.carto.com/builder/1a581f66-353a-11e7-84ef-0e3ff518bd15/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
</div>
  </div>
  ...
  <footer class="page-footer orange">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">私について</h5>
          <p class="grey-text text-lighten-4">私は、HTML、PHP、Node.js、および関連するプログラミング言語での作業が大好きです。 CGIとPerlをサポートしているWebホスティングだけがあれば、Webゲームを作ることができます！</p>
    ...
    <div class="footer-copyright">
      <div class="container">
      © 2017 <a class="orange-text text-lighten-3" href="https://seetow.com">シート.</a> 全著作権所有. Materialiseで作った. CDN kindly provided by StackPath, RawGit and GitHub.
      </div>
    </div>
  </footer>
